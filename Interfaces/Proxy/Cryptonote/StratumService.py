...
#   Stratum
from Interfaces.Stratum.pubsub import Subscription

from Interfaces.Stratum.services import GenericService
from Interfaces.Stratum.pubsub import Pubsub
from Interfaces.Stratum.custom_exceptions import ServiceException, RemoteServiceException
...
class ProxyMiningSubscription(Subscription):
    ...
    def disconnect_all(cls):
        ProxyStratumService.registered_tails = []
...
class ProxyStratumService(GenericService):
    service_type = 'mining'
    ...
    def login(self, params, *args):
        ...
        try:
            ...
            pass
        subs = Pubsub.subscribe(self.connection_ref(), ProxyMiningSubscription())[0]

        ProxyMiningSubscription.add_user_id(subs[2], first_job['id'])
